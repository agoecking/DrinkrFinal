...
namespace Drinkr.Controllers
{
    public class MotoristasController : Controller
    {
        ...
        public MotoristasController(DrinkrContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,Cpf,Telefone,Idade")] Motorista motorista)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,Cpf,Telefone,Idade")] Motorista motorista)
        {
            if (id != motorista.Id)
            {
                return NotFound();
