...
namespace Drinkr.Controllers
{
    public class CartaosController : Controller
    {
        ...
        public CartaosController(DrinkrContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Numero,Nome,Validade")] Cartao cartao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Numero,Nome,Validade")] Cartao cartao)
        {
            if (id != cartao.Id)
            {
                return NotFound();
