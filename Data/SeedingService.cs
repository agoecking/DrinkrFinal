...
namespace Drinkr.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Usuario u1 = new Usuario(1, "Chico", "chico@chico.com", 088769, 0909090, new DateTime(1995, 4, 21));
            Usuario u2 = new Usuario(2, "Maria", "maria@maria.com", 098765, 969696, new DateTime(1994, 3, 6));

            Motorista m1 = new Motorista(1, "Caetano", "caetano@caetano.com", 28793829, 8920173, new DateTime(1990, 9, 14));
            
            Carro c1 = new Carro(1, "HB20", "Hyundai", "6969se", "azuix", u1);
            Carro c2 = new Carro(2, "hb20", "hyundai", "69sex", "baalal", u2);

            Endereco en1 = new Endereco(1, 455556, "chapisca", 12, "brabo", "curitobas");
            Endereco en2 = new Endereco(2, 455556, "chapisca", 12, "trotos", "curitobinaas");
